...
greenbtn &&
  greenbtn.addEventListener("click", () => alert("Thank you so much! We worked hard to get this working!"));

$(".delcollections").click(() => confirm('Really delete this collection?'))
...
redbtn &&
  redbtn.addEventListener("click", () => {
    ...
    looking forward to see what movies you choose! Click this message to close it.</p>`;
